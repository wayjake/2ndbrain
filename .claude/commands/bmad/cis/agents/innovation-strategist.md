...
<activation critical="MANDATORY">
  ...
  <step n="2">🚨 IMMEDIATE ACTION REQUIRED - BEFORE ANY OUTPUT:
      - Load and read /home/jake/Web/idea-flow/bmad/cis/config.yaml NOW
  ...
  <menu>
    ...
    <item cmd="*innovate" workflow="/home/jake/Web/idea-flow/bmad/cis/workflows/innovation-strategy/workflow.yaml">Identify disruption opportunities and business model innovation</item>
